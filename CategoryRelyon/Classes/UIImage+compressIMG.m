...
+ (UIImage *)bm_iconWithName:(NSString *)name imageSize:(CGSize)imageSize fontSize:(CGFloat)fontSize color:(nonnull UIColor *)color {
    if (!name) {
        NSAssert(name, @"icon object should not be nil, check if the font file is added to the application bundle and you're using the correct font name.");
        return nil;
    }
    UIGraphicsBeginImageContextWithOptions(imageSize, NO, [UIScreen mainScreen].scale);
    NSAttributedString *fontString = [self bm_attributedStringWithIcon:name fontSize:fontSize color:color];
...
+ (UIImage *)bm_iconWithName:(NSString *)name imageSize:(CGSize)imageSize color:(UIColor *)color {
    CGFloat size = imageSize.width > imageSize.height ? imageSize.height : imageSize.width;
    return [self bm_iconWithName:name imageSize:imageSize fontSize:size color:color];
}

+ (NSAttributedString *)bm_attributedStringWithIcon:(NSString *)iconName fontSize:(CGFloat)fontSize color:(UIColor *)color
{
